  ...
  connection.createChannel((err, ch) => {
    ...
    channel.consume('order_events', (msg) => {
      ...
      if (event.type === 'Order Placed') {
        ...
        console.log(`User Service received Order Created event: Order ID: ${orderId}, Product ID: ${productId} , Quantity: ${quantity}`);
    ...
    channel.consume('product_events', (msg) => {
      ...
      if (event.type === 'Product Created') {
        ...
        console.log(`User Service received Product Created event: Product ID: ${productId}, Name: ${name}`);
